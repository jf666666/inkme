...
struct RequestVariables: Codable {
    let coopHistoryDetailId: String?
    let vsResultId: String?
    let festId: String?
    
    enum CodingKeys: String, CodingKey {
        case coopHistoryDetailId = "coopHistoryDetailId"
        case vsResultId = "vsResultId"
        case festId = "festId"
    }
}
